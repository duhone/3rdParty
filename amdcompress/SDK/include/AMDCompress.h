...
typedef char                AMD_TC_CHAR;          ///< An 8-bit char    format.
...
typedef enum
{
   ...
   AMD_TC_FORMAT_ASTC,                       ///< ASTC (Adaptive Scalable Texture Compression) open texture compression standard
   //--------------------------------------------------------------------------------------------------------
...
typedef struct
{
    AMD_TC_CHAR strCommand[AMD_MAX_CMD_STR];
    AMD_TC_CHAR strParameter[AMD_MAX_CMD_PARAM];
} AMD_CMD_SET;
...
extern "C" {
    ...
    //
    BC_ERROR AMD_TC_API AMD_TC_InitializeBCLibrary();
    
    //
    // ShutdownBCLibrary - Shutdown the BC6H or BC7 library
    //
    BC_ERROR AMD_TC_API AMD_TC_ShutdownBCLibrary();
    ...
    // 
    BC_ERROR AMD_TC_API AMD_TC_CreateBC6HEncoder(bool isSigned, double quality, AMD_TC_DWORD modeMask, BC6HBlockEncoder** encoder);
    BC_ERROR AMD_TC_API AMD_TC_CreateBC7Encoder(double quality, BOOL restrictColour, BOOL restrictAlpha, AMD_TC_DWORD modeMask, double performance, BC7BlockEncoder** encoder);
    ...
    //
    BC_ERROR AMD_TC_API AMD_TC_EncodeBC7Block(BC7BlockEncoder* encoder, double in[BC_BLOCK_PIXELS][BC_COMPONENT_COUNT], BYTE* out);
    BC_ERROR AMD_TC_API AMD_TC_EncodeBC6HBlock(BC6HBlockEncoder* encoder, AMD_TC_FLOAT  in[BC_BLOCK_PIXELS][BC_COMPONENT_COUNT], BYTE* out);
    ...
    //
    //
    BC_ERROR AMD_TC_API AMD_TC_DecodeBC6HBlock(BYTE* in, AMD_TC_FLOAT  out[BC_BLOCK_PIXELS][BC_COMPONENT_COUNT]);
    BC_ERROR AMD_TC_API AMD_TC_DecodeBC7Block(BYTE* in, double out[BC_BLOCK_PIXELS][BC_COMPONENT_COUNT]);
    ...
    //
    //
    BC_ERROR AMD_TC_API AMD_TC_DestroyBC6HEncoder(BC6HBlockEncoder* encoder);
    BC_ERROR AMD_TC_API AMD_TC_DestroyBC7Encoder(BC7BlockEncoder*  encoder);
